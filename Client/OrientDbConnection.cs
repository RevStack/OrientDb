...
namespace RevStack.OrientDb.Client
{
    public class OrientDbConnection : DbConnection, IDbConnection
    {
        ...
        private void Connect()
        {
            ...
            var response = HttpClient.SendRequest(url, "GET", "", _username, _password, _sessionId);
            ...
            {
                throw new ApplicationException(string.Format("{0} {1}", response.StatusCode, response.StatusString));
            }
